...
"""The modoo API module defines modoo Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~modoo.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~modoo.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/modoo/modoo/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def envs(cls):
        raise NotImplementedError(
            "Since modoo 15.0, Environment.envs no longer works; "
    ...
    def manage(cls):
        warnings.warn(
            "Since modoo 15.0, Environment.manage() is useless.",
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~modoo.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~modoo.addons.base.models.res_users`"""
    ...
    def clear_upon_failure(self):
        ...
        """
        warnings.warn(
            "Since modoo 15.0, use cr.savepoint() instead of env.clear_upon_failure().",
            DeprecationWarning, stacklevel=2,
        )
...
from modoo.exceptions import UserError, AccessError, MissingError
