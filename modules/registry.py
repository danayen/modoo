...
from modoo.sql_db import TestCursor
from modoo.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql,
                        Collector, OrderedSet)
from modoo.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('modoo.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # modoo.service.wsgi_server.application
    ...
    def new(cls, db_name, force_demo=False, status=None, update_module=False):
        ...
        with cls._lock:
            ...
            try:
                ...
                try:
                    modoo.modules.load_modules(registry, force_demo, status, update_module)
                except Exception:
                    modoo.modules.reset_modules_state(db_name)
                    raise
            except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = modoo.tests.runner.modooTestResult()
        ...
        self._db = modoo.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = modoo.modules.db.has_unaccent(cr)
            self.has_trigram = modoo.modules.db.has_trigram(cr)
