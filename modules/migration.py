...
from modoo.modules.module import get_resource_path
import modoo.release as release
import modoo.upgrade
from modoo.tools.parse_version import parse_version
...
class MigrationManager(object):
    ...
    def _get_files(self):
        def _get_upgrade_path(pkg):
            for path in modoo.upgrade.__path__:
    ...
    def migrate_module(self, pkg, stage):
        ...
        def compare(version):
            ...
            if majorless_version:
                # We should not re-execute major-less scripts when upgrading to new modoo version
