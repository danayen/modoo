...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching modoo.
    """
    name = 'traces_sync'
    ...
    def __exit__(self, *args):
        try:
            ...
            if self.db:
                ...
                from modoo.sql_db import db_connect  # only import from modoo if/when needed.
