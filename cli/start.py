...
from modoo.modules.module import get_module_root, MANIFEST_NAMES
from modoo.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            modoo.tools.config['init']['base'] = True
